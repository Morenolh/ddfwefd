...
AddEventHandler('renfort:setBlip', function(coords, raison)
	if raison == 'petit' then
		...
		ESX.ShowAdvancedNotification('LSPD Informacion', '~b~Solicitud de refuerzo', 'Solicitud de refuerzo entrante.\nRéponse: ~g~CODE-2\n~w~Importance: ~g~Ligero.', 'CHAR_CALL911', 8)
		Wait(1000)
...
AddEventHandler('police:InfoService', function(service, nom)
	if service == 'prise' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('LSPD Informacion', '~b~Empezo su servicio', 'Agente: ~g~'..nom..'\n~w~Codigo: ~g~10-8\n~w~Informacion: ~g~Empezo su servicio.', 'CHAR_CALL911', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'fin' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('LSPD Informacion', '~b~Fin de servicio', 'Agente: ~g~'..nom..'\n~w~Codigo: ~g~10-10\n~w~Informacion: ~g~Fin de servicio.', 'CHAR_CALL911', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'pause' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('LSPD Informacion', '~b~Pausa de servicio', 'Agente: ~g~'..nom..'\n~w~Codigo: ~g~10-6\n~w~Informacion: ~g~Pauso su servicio.', 'CHAR_CALL911', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'standby' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('LSPD Informacion', '~b~En espera', 'Agente: ~g~'..nom..'\n~w~Codigo: ~g~10-12\n~w~Informacion: ~g~En espera, Esperando asignacion.', 'CHAR_CALL911', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'control' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('LSPD Informacion', '~b~Control rutinario', 'Agente: ~g~'..nom..'\n~w~Codigo: ~g~10-48\n~w~Informacion: ~g~Control rutinario en curso.', 'CHAR_CALL911', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'refus' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('LSPD Informacion', '~b~Negativa a cumplir', 'Agente: ~g~'..nom..'\n~w~Codigo: ~g~10-30\n~w~Informacion: ~g~Negativa a cumplir.', 'CHAR_CALL911', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	elseif service == 'crime' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('LSPD Informacion', '~b~Crimen en curso', 'Agente: ~g~'..nom..'\n~w~Codigo: ~g~10-31\n~w~Informacion: ~g~Crimen en curso.', 'CHAR_CALL911', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
	end
end)
      ...
      while true do
          ...
          Citizen.Wait(1)    
              ...
              if (affichenews == true) then
                  ...
                  DrawAdvancedTextCNN(0.588, 0.14, 0.005, 0.0028, 0.8, "~r~ LSPD ~d~", 255, 255, 255, 255, 1, 0)
